...
author: "Updated from Devika Agarwal, Carla Cohen"
institute: "Oxford Biomedical Data Science Training Programme"
date: "2023-08-16 (updated: `r Sys.Date()`)"
date-format: long
format:
  revealjs: 
    slide-number: true
...
BibOptions( 
  ...
  max.names = 2,
  no.print.fields = c("issn", "url", "abstract", "number", "urldate", "month", "pages", "file"),
  style = "markdown",
  hyperlink = "to.doc",
  dashed = TRUE)
...
- Launch RStudio Server on the teaching cluster.xx
