...
1. Construct a negative binomial generalised linear model (GLM) for each gene
...
2. Parameter estimates are regularised to avoid model overfitting, pooling information across genes.
