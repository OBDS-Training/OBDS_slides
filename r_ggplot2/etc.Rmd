...
- Draw a bar plot of number of observations (i.e., rows) for each taxonomic order (i.e., one bar per taxonomic order).
...
- Change the text and font size of the title for both x and y axes.
