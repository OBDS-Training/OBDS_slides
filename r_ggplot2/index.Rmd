...
- The R package `r BiocStyle::CRANpkg("renv")`
]
...
- In the daily sub-directory, make a copy the `template` sub-directory with your HPC username.

> e.g. `cp template albrecht`
...
- Launch the RStudio project `r_ggplot2.Rproj` in your sub-directory.
