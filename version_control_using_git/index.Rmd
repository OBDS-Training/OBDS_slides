...
- _Repositories_ can be kept in sync across different computers (i.e. _remotes_).
...
- However, deleting the `.git` sub-directory does not affect the _current state_ of the other sub-directories and files that make up your project.

.center[
**The history of changes is separate from the files themselves.**
]
