...
Read <https://hbctraining.github.io/DGE_workshop_salmon_online/lessons/02_DGE_count_normalization.html>.
...
- RNA-seq count data is modelled using the Negative Binomial distribution.
- Heteroskedastic data show association between variance and mean.
