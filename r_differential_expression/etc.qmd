...
- Which genes are significantly *up- or down-regulated* in group A relative to group B?
- Which genes are significantly affected by the *interaction* of covariates A and B?
...
- Range of methods including
  ...
  and `r BiocStyle::Biocpkg("DEXSeq")`.
