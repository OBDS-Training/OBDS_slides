...
`r BiocStyle::Biocpkg("DESeq2")` offers a choice of multiple testing correction methods.

The default settings add *independent filtering* prior to multiple testing correction:
...
- The Benjamini-Hochberg multiple testing correction method is applied to the remaining genes.

**Remember:** Lowly expressed genes are less likely to be differentially expressed (higher dispersion).
