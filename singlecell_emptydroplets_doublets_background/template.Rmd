...
- Import the raw matrix into <i class="fab fa-r-project"></i>; use `DropletUtils`.
...
> The output is a table with a row for each GEL barcode and columns for various pieces of information.
