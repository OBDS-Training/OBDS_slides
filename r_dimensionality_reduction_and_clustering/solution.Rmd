...
> Each value in the matrix above represents the weight of the corresponding variable on the corresponding principal component.
> Higher (absolute) weight represent a higher importance of the variable on the principal component.
...
Save the UMAP plot as an object named `umap_iris_species`.
...
Save the t-SNE plot as an object named 
...
- Combine PCA, UMAP and t-SNE in a single figure.
...
cowplot::plot_grid(
  dbscan_plot, hdbscan_plot, ncol = 2)
```
...
> cluster 2 contains mostly virginica observations,
