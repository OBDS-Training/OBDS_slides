...
- Perform PCA.
  How many principal components do you think you should keep for follow up analysis?

- Use the experimental metadata to visualise which cell types visually cluster together in principal component space.

- Investigate which groups of cells the top principal components are separating.
...
.x-large-list[
- Which method would you use to cluster the data?
