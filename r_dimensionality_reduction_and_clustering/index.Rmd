...
- Download the shared folder `r/dimensionality_reduction_and_clustering/data` from the CGAT cluster as a subdirectory of the OBDS environment in your personal repository.
