...
# Earlier: pca <- prcomp(matrix)
# Now: visualise loadings for the first five genes and principal components
...
- Separate measurements from class labels.
  ...
  + Store the matrix of measurements in a separate object named `iris_features`.
