...
- Non-linear techniques are able to more accurately capture non-linear patterns in the data.
...
.center[
**No wrong choice. It doesn't hurt to run both and pick the best-looking one.**
]
...
.pull-left[
```{r, include=TRUE, echo=FALSE, out.height='250px', out.width='300px', fig.align='center'}
