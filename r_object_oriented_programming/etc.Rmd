...
- Designing and documenting how to use classes is the responsibility of software developers.

- Learning to use those classes through the documentation is the responsibility of users.
