...
- Similarly to the `separate()` function, the original columns being split or combined are not retained from the resulting table.
...
```{r, include=TRUE}
str_sub(iris_species, 1, 3) %>% unique()
```
...
[<img src="img/haven.png" height="100px" align="top" style="float: left">](https://haven.tidyverse.org/index.html)
enables R to read and write various data formats used by other statistical packages (e.g., SAS, SPSS, Stata)
