...
- Create and launch a new RStudio project in `/project/obds/$USER/projects/tidyverse`.
...
> ```
> cp \
>   /project/obds/$USER/git/week2day5-tidyverse/template.Rmd \
>   /project/obds/$USER/projects/tidyverse/tidyverse-kevinrue.Rmd
> ```
