...
.pull-left[
```{r, include=TRUE, echo=FALSE, out.height='200px'}
...
```{r, include=TRUE, echo=FALSE, out.height='300px'}
...
```{r, include=TRUE, echo=FALSE, out.height="60px", out.width="400px"}
...
```{r, include=TRUE, echo=FALSE, out.height='500px', out.width='400px'}
## Source: Kevin Rue-Albrecht (Illustrator)
...
.pull-right[
```{r, include=TRUE, echo=FALSE, fig.height=4, warning=FALSE}
...
```{r, include=TRUE, echo=FALSE, fig.height=7, fig.width=10}
Idents(seurat_object) <- "RNA_snn_res.0.3"
