...
```{r, include=TRUE, echo=FALSE, fig.align='center', out.height='500px', out.width='400px'}
## Source: Kevin Rue-Albrecht (Illustrator)
knitr::include_graphics("img/overview-analysis-qc.png")
```
...
- `VlnPlot()` produces a violin plot for a selection of per-cell metrics, including gene expression, quality control metrics, and dimensionality reduction results available in a Seurat object.
