...
You have made a _commit_ in the _clone_ of the _repository_ on the teaching cluster.

- The <i class="fab fa-github"></i> GitHub _clone_ of the _repository_ does not about it yet.
...
```{r, fig.align='center', out.height='400px', out.width='900px'}
...
```{r, fig.align='center', out.height='300px', out.width='900px'}
# Screenshot (Kevin Rue-Albrecht)
...
.pull-right[
```{r, fig.align='center', out.height='125px', out.width='475px'}
# Source: Kevin Rue-Albrecht (Adobe Illustrator)
...
- This does not (cannot!) automatically update the files in your _clone(s)_ on clusters and personal computers.
