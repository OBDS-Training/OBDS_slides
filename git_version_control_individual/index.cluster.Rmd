...
subtitle: 'Using individual repositories on the CCB cluster'
...
.center[
_We need to set an SSH key pair between the teaching cluster and GitHub._
]
...
- In the Terminal application, on the teaching cluster, create an SSH key pair.
