...
- Perform GSEA using `fgsea::fgsea()`.
...
|              | ORA                                  | GSEA                                 |
|--------------|--------------------------------------|--------------------------------------|
| **Input**    | Subset of genes based on a threshold and background     | All genes ranked based on a gene statistic   |
| **Analysis** | Equal importance of genes            | Ranked importance of genes           |
:::
...
In both cases, a table of statistics used to evaluate enrichment in your gene list.

## Choosing an enrichment analysis tool
...
- Do you need to use ORA or FCS?

**User interface**

- Do you prefer web-based or scripted?

**Flexibility**

- Do it accept a custom background for ORA?
- Which gene set databases does it support?
:::

::: {.column width="50%"}
**Compatibility**

- Does the tool support the gene identifiers you are using?
- Does it convert them internally to another identifier?

**Maintenance**

- Is the tool well documented and maintained?

**Gene set database**

- Which one answers your scientific question?
- Is it up-to-date?
:::
