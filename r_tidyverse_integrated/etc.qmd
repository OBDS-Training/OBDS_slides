...
You are expected you to use <i class="fab fa-r-project"></i> and `tidyverse` functions seen in previous lessons to assemble a workflow and complete the following analysis:
...
- Convert each of the four columns above to factors.
