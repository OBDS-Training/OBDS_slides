...
- Different ways
  + Google search!
  + Use in combination with command-line ways for more information that is accurate or up to date
...
- Example globs (termed used in Linux):
```
...
11. Use history command to view previously executed commands
...
4. Use history command to view previously executed commands
