...
- Basic part/s (<span style="color:red;">\<arrows></span> indicates that this part is to be replaced accordingly, removing also the arrows)
  + \<command>      
  + \<command> \<argument> 
...
- <span style="color:red;">Note!</span>
  + \<arrows> - indicates that this part is to be replaced accordingly, removing also the arrows
...
- In bioinformatics, binary formats (e.g., SAM and BAM) are commonly used to compress equivalent plain text files
