...
Give paths to course working directory and resources directory.
...
5. Change into the resources directory. List files in and/or explore the directory.
...
3. Copy **SRR2121685h_1.fastq** from **1_linux/1_linux_intro/** in resources directory to your **1_linux** directory.
