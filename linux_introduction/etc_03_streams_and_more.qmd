...
1. Find the tar archive dnase1.tar.gz in your 1_linux directory
2. Decompress and extract the archive using the tar command
3. Move into the bed directory and count the number of lines in each .bed file
4. Print the first 5 lines of the file cpg.bed. Compress the cpg.bed file in place and then head the compressed file.
...
9. Find the fasta format files in the folder /databank/raw/hg19_full/. How many are there?
10. Find all the bed format files in the folder /datashare/courses/obds/bedfiles and count the number of lines in each file
