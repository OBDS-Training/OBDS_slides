...
- Identify markers for each cluster; use `r BiocStyle::Biocpkg("scran")`.

- At every step, take the time to _visualise_ results and relate them to the raw/normalised data; try `r BiocStyle::Biocpkg("iSEE")`.

- Bonus point: Import the raw matrix, and:
