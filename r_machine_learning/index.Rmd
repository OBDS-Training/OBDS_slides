...
We will use machine learning to build a model that predicts the value of properties based on various pieces of information about the property and its environment.
...
- Can we improve the predictive accuracy of our model using other variables (or combinations thereof) in the data set?
