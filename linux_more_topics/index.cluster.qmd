...
subtitle: ''
author: "Updated from Devika Agarwal, Carla Cohen, Kevin Rue Albrecht (CCB Doks)"
...
format:
  revealjs: 
    ...
    css: styles.css
    fontsize: 1.5em
    footer: Updated from Devika Agarwal, Carla Cohen, Kevin Rue Albrecht (CCB Doks) -- Introduction to the Linux command line, part 2
