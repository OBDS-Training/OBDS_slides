...
```{bash, eval=FALSE}
cd <course working directory>/1_linux/
mkdir rnaseq
```
...
# Alternatively, you can change the text of the links below (e.g. to download 
# release 110, change 102 to 110 in the links) but this approach is subject to 
# typos
