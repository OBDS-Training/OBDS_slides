...
3.To easily connect to the server *via* the bastion host, configure your ssh client. Download the OBDS config file template and transfer to your local ~/.ssh folder.
