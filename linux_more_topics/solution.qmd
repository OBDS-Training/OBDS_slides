...
3.To easily connect to the server *via* the bastion host, configure your ssh client. Get the OBDS config file template in the resources directory and transfer to your local ~/.ssh folder.
