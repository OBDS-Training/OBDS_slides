...
<span style="color:green;">DEMO connection to OBDS server</span>
...
<span style="color:green;">DEMO (download from Ensembl)</span>
...
<span style="color:green;">DEMO (download from ENA)</span>
...
- `scp` 
   + Straightforward copying of files using SSH
- `rsync`
   + Synchronises files and directories between a source and a destination 
