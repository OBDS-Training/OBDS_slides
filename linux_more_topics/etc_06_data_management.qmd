...
```
$ wget http…/md5.out            # Download checksum file to local system
```
...
```
$ md5sum -c md5.out             #  Compare the value obtained for the downloaded file to the reference value in md5.out
```
