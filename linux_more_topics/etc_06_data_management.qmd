...
- Users can compare locally generated checksums with those provided by the source to verify file integrity
...
6. Download the fasta file for the mouse genome (GRCm38, release 102) from Ensembl to **genome/** and check it downloaded correctly using the CHECKSUMS file that can also be downloaded from the database.
...
7. Download the annotation GTF file for the mouse (release 102) genome from Ensembl to **genome/** and check it downloaded correctly using the CHECKSUMS file that can also be downloaded from the database.
...
8. Create a **README.txt** file in the **genome/** detailing how you obtained the public data files.
...
9. Create an analysis lab-book called **rnaseq_commands.txt** in **rnaseq/**.
