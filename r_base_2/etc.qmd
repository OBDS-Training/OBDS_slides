...
The function `aggregate()` takes a data frame, a list of grouping variables, and a function to compute on each group of values in each column of the data frame.
