...
- Import sequences in the file `TruSeq3-PE-2.fa`.
  What other file formats can `r BiocStyle::Biocpkg("Biostrings")` read?
...
knitr::include_graphics("img/bsgenome-biocviews.png")
```
]
...
- `elementMetadata`, to store metadata for each element in the vector.
...
.pull-left[
```{r, include=TRUE, echo=FALSE}
knitr::include_graphics("img/bsgenome-biocviews.png") # TODO
```
]

.pull-right[
- The `r BiocStyle::Biocpkg("rtracklayer")` package provides core functionality.
