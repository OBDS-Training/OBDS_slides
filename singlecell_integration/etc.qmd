...
If there's time, we will also use [Harmony](https://portals.broadinstitute.org/harmony/) (within the Seurat workflow).
...
Seurat v3 introduced new functionality to identify correspondences between cells in different experiments.
...
### Merge two PBMC data sets without integration
...
### Integrate datasets using Seurat v5
