...
- Two mutually exclusive outcomes: $P(H) = 1 - P(T)$

- Size of experiment (e.g., number of coins tossed)
...
> ```
> cp \
>   /project/obds/$USER/projects/statistics/statistics-kevinrue.Rmd \
>   /project/obds/$USER/git/week3day1-statistics/
> ```
]

- Create a new branch in the Git repository.
  Use the date and your username in the branch name to make it unique, e.g. `git checkout -b week3day1-kevinrue`.
