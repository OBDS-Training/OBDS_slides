...
::: {.column width="50%"}
```{r, include=TRUE, echo=FALSE, fig.height=3, fig.width=4, out.height="250px", fig.align='center'}
df <- data.frame(
    value = c(1:10, 5:14),
...
```{r, include=TRUE, echo=FALSE, fig.height=4, fig.width=5, out.height="250px", fig.align='center'}
